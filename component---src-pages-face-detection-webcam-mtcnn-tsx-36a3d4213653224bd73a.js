	...
	var DetectFacesMtcnn = function (_React$Component) {
	    ...
	    DetectFacesMtcnn.prototype.detectFaces = function () {
	        var _ref = _asyncToGenerator(function* () {
	            ...
	            var mtcnnResults = yield this.props.mtcnn.forwardWithStats(this.props.input.element, this.props.detectionParams);
	            console.log(mtcnnResults.stats);
	            this.setState({
	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement(Root_1.Root, null, React.createElement(WebcamVideoWithOverlay_1.WebcamVideoWithOverlay, { onLoaded: function onLoaded(_ref) {
	            ...
	            }, maxVideoWidth: 800 }), React.createElement(AdjustableInput_1.AdjustableInput, { inputId: "scaleFactor", label: "scaleFactor:", value: this.state.detectionParams.scaleFactor, minValue: 0.1, maxValue: 0.9, step: 0.05, onChange: function onChange(scaleFactor) {
	                return _this2.setState({
	                    detectionParams: _extends({}, _this2.state.detectionParams, { scaleFactor: scaleFactor })
	                });
...
//# sourceMappingURL=component---src-pages-face-detection-webcam-mtcnn-tsx-36a3d4213653224bd73a.js.map