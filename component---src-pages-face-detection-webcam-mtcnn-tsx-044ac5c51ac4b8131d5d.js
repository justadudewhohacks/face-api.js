...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.DetectFacesMtcnnNoLoader = withAsyncRendering_1.withAsyncRendering(detectFaces);
	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement(Root_1.Root, null, React.createElement(WebcamVideoWithOverlay_1.WebcamVideoWithOverlay, { onLoaded: function onLoaded(_ref) {
	            ...
	            } }), React.createElement(LoadModels_1.LoadModels, { mtcnnModelUrl: const_1.MODELS_URI }, function (_ref2) {
	            var mtcnn = _ref2.mtcnn;
	            return _this2.state.inputVideo.isLoaded && React.createElement(DetectFacesMtcnn_1.DetectFacesMtcnnNoLoader, { mtcnn: mtcnn, input: _this2.state.inputVideo, detectionParams: _this2.state.detectionParams }, function (_ref3) {
...
//# sourceMappingURL=component---src-pages-face-detection-webcam-mtcnn-tsx-044ac5c51ac4b8131d5d.js.map