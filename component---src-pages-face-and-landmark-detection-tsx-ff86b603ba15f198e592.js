	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement(Root_1.Root, null, React.createElement(SelectableImage_1.SelectableImage, { items: const_1.EXAMPLE_IMAGES, initialImageSrc: const_1.EXAMPLE_IMAGES[0].url, onLoaded: function onLoaded(_ref) {
	            ...
	            return withLandmarks ? React.createElement(DetectFacesWithLandmarks_1.DetectFacesWithLandmarks, { input: _this2.state.input, detectionOptions: detectionOptions }, function (_ref3) {
	                ...
	                return React.createElement(DisplayResults_1.DisplayResults, { input: _this2.state.input, overlay: _this2.state.overlay, results: faceDetectionsWithLandmarks, displayResultsOptions: { withBoxes: withBoxes } });
	                ...
	                return React.createElement(DisplayResults_1.DisplayResults, { input: _this2.state.input, overlay: _this2.state.overlay, results: faceDetections, displayResultsOptions: { withBoxes: withBoxes } });
	            });
	        }));
	    };
...
//# sourceMappingURL=component---src-pages-face-and-landmark-detection-tsx-ff86b603ba15f198e592.js.map