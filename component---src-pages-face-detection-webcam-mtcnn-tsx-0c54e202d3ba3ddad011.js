...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DetectFacesMtcnn = function (_React$Component) {
	    ...
	    DetectFacesMtcnn.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
	        if (this.props.mtcnn !== nextProps.mtcnn || this.props.detectionParams !== nextProps.detectionParams || this.props.input !== nextProps.input || this.props.children !== nextProps.children) {
	            this.detectFaces();
	        }
	    };
	    ...
	    DetectFacesMtcnn.prototype.shouldComponentUpdate = function shouldComponentUpdate(_, nextState) {
	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement(Root_1.Root, null, React.createElement(WebcamVideoWithOverlay_1.WebcamVideoWithOverlay, { onLoaded: function onLoaded(_ref) {
	            ...
	            }, maxVideoWidth: 800 }), React.createElement(AdjustableInput_1.AdjustableInput, { inputId: "foo", label: "foo:", value: this.state.detectionParams.minFaceSize, minValue: 40, maxValue: 400, step: 40, onChange: function onChange() {
	                return _this2.setState({ inputVideo: new VideoWrap_1.VideoWrap(_this2.state.inputVideo) });
	            ...
	            return React.createElement(DetectFacesMtcnn_1.DetectFacesMtcnn, { mtcnn: mtcnn, input: _this2.state.inputVideo, detectionParams: _this2.state.detectionParams, onStartDetection: function onStartDetection() {
	                    _this2.isBusy = true;
	                } }, function (mtcnnResults) {
...
//# sourceMappingURL=component---src-pages-face-detection-webcam-mtcnn-tsx-0c54e202d3ba3ddad011.js.map