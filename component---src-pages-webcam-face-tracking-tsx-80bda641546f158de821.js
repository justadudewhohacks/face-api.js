	...
	var FaceAndLandmarkDetection = function (_React$Component) {
	    ...
	    FaceAndLandmarkDetection.prototype.render = function render() {
	        ...
	        return React.createElement(SelectFaceDetector_1.SelectFaceDetector, { initialFaceDetector: this.props.initialFaceDetector, initialTinyFaceDetectorOptions: this.props.initialTinyFaceDetectorOptions }, function (detectorName, detectionOptions, renderFaceDetectorSelection, renderFaceDetectorControls) {
	            return React.createElement(face_api_js_react_1.LoadModels, _extends({}, const_1.getFaceDetectionModelUri(detectorName, const_1.MODELS_URI), { faceLandmarkModelUrl: "/models", renderBusyComponent: function renderBusyComponent() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WebcamVideoWithOverlay = function (_React$Component) {
	    ...
	    WebcamVideoWithOverlay.prototype.render = function render() {
	        return React.createElement(VideoWithOverlay_1.VideoWithOverlay, { srcObject: this.state.srcObject });
	    };
...
//# sourceMappingURL=component---src-pages-webcam-face-tracking-tsx-80bda641546f158de821.js.map