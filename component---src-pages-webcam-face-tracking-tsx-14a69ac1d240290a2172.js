	...
	var TrackFaces = function (_React$Component) {
	    ...
	    function TrackFaces() {
	        ...
	        _this.run = _asyncToGenerator(function* () {
	            ...
	            face_api_js_react_1.displayResults(_this.props.input, _this.props.overlay, results, { withBoxes: withBoxes });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var VideoWithOverlay = function (_React$Component) {
	    ...
	    VideoWithOverlay.prototype.render = function render() {
	        return React.createElement("div", { style: { position: 'relative' } }, React.createElement("video", { muted: true, autoPlay: true, style: { width: '100%', maxWidth: this.props.maxVideoWidth }, ref: this.onVideoRef, onPlay: this.onPlay, src: this.props.src }), React.createElement("canvas", { style: { position: 'absolute', top: 0, left: 0 }, ref: this.onCanvasRef }));
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WebcamVideoWithOverlay = function (_React$Component) {
	    ...
	    function WebcamVideoWithOverlay() {
	        ...
	        _this.state = {};
	        _this.onVideoRef = _asyncToGenerator(function* () {
	            try {
	                var srcObject = yield navigator.mediaDevices.getUserMedia({ video: {} });
	                _this.setState({ srcObject: srcObject });
	            } catch (err) {
	    ...
	    WebcamVideoWithOverlay.prototype.render = function render() {
	        if (this.state.error) {
	            return React.createElement("div", { style: { background: 'red', color: 'white' } }, React.createElement("h3", null, " Error occured while requesting webcam access: "), React.createElement("p", null, " ", this.state.error, " "));
	        }
	        return React.createElement(VideoWithOverlay_1.VideoWithOverlay, { srcObject: this.state.srcObject, onLoaded: this.props.onLoaded, maxVideoWidth: this.props.maxVideoWidth, onVideoRef: this.onVideoRef });
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var WebcamVideoWithOverlay_1 = __webpack_require__(710);
	var const_1 = __webpack_require__(38);
	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement(Root_1.Root, null, React.createElement(WebcamVideoWithOverlay_1.WebcamVideoWithOverlay, { onLoaded: function onLoaded(_ref) {
	            ...
	            }, maxVideoWidth: 800 }), React.createElement(FaceAndLandmarkDetection_1.FaceAndLandmarkDetection, _extends({}, this.state, { initialFaceDetector: const_1.FACE_DETECTORS[0], initialTinyFaceDetectorOptions: new face_api_js_1.TinyFaceDetectorOptions({ inputSize: 128 }) }), function (detectionOptions, options) {
...
//# sourceMappingURL=component---src-pages-webcam-face-tracking-tsx-14a69ac1d240290a2172.js.map