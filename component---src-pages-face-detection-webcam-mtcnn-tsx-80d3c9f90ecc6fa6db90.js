...
/***/ (function(module, exports, __webpack_require__) {
	...
	var VideoWithOverlay = function (_React$Component) {
	    ...
	    VideoWithOverlay.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
	        return nextProps.srcObject !== this.props.srcObject;
	    };
	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement(Root_1.Root, null, React.createElement(VideoWithOverlay_1.VideoWithOverlay, { srcObject: this.state.inputVideo.srcObject, onLoaded: function onLoaded(_ref) {
	                ...
	                return _this3.setState({ inputVideo: inputVideo, overlay: overlay, isPlaying: true });
...
//# sourceMappingURL=component---src-pages-face-detection-webcam-mtcnn-tsx-80d3c9f90ecc6fa6db90.js.map