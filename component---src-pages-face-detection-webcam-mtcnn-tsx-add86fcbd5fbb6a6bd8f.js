...
/***/ (function(module, exports, __webpack_require__) {
	...
	var default_1 = function (_React$Component) {
	    ...
	    default_1.prototype.render = function render() {
	        ...
	        return React.createElement(Root_1.Root, null, React.createElement("video", { muted: true, autoPlay: true, ref: this.onVideoRef, onPlay: function onPlay() {
	            ...
	            } }), React.createElement(LoadModels_1.LoadModels, { mtcnnModelUrl: gatsby_link_1.withPrefix('/models') }, function (_ref) {
	            var mtcnn = _ref.mtcnn;
...
//# sourceMappingURL=component---src-pages-face-detection-webcam-mtcnn-tsx-add86fcbd5fbb6a6bd8f.js.map